...
/** Paid plan prices are intentionally undisclosed until public market launch. */
const PRICES_PUBLIC = false;
...
const PLANS = [
  ...
  },
  {
    id: 'pro',
    name: 'Pro',
    priceLabel: PRICES_PUBLIC ? '₹799' : 'Price on request',
    priceHint: PRICES_PUBLIC ? '/mo' : 'Shared at market launch',
    badge: 'Most Popular',
    description: 'For serious creators who want to stay ahead of every trend.',
    cta: PRICES_PUBLIC ? 'Start Pro Trial' : 'Get early access',
    ctaHref: '/signup',
    highlight: true,
    features: [
  ...
  },
  {
    id: 'agency',
    name: 'Agency',
    priceLabel: PRICES_PUBLIC ? '₹2,999' : 'Price on request',
    priceHint: PRICES_PUBLIC ? '/mo' : 'Shared at market launch',
    badge: 'Best Value',
    description: 'For agencies and teams managing multiple brands.',
    cta: PRICES_PUBLIC ? 'Contact Sales' : 'Talk to us',
    ctaHref: '/signup',
    highlight: false,
    features: [
      { text: 'Unlimited niches', included: true },
...
const FAQS = [
  {
    q: 'When will paid plan prices be published?',
    a: 'Pro and Agency pricing will be announced at public market launch. Until then, start on Free or sign up for early access — we will share packages directly with early partners.',
  },
  {
    q: 'Can I switch plans anytime?',
    a: 'Yes. Once paid plans are live you can upgrade or downgrade anytime. Until launch, Free gives you full product access within Free limits.',
  },
  {
    q: 'Is there a free way to try Nemo?',
    a: 'Yes — the Free plan is available now with no credit card. Paid billing (including Razorpay) will open at market launch.',
  },
  {
    q: 'What happens to my data if I change plans later?',
    a: 'Your data stays with your account. Plan changes only affect feature limits, not your saved trends, scripts, or history.',
  },
];
      ...
      <div className="max-w-5xl mx-auto px-4 py-14">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground font-sans text-lg sm:text-xl max-w-xl mx-auto font-medium">
            Start free today. Paid package pricing will be published at market launch.
          </p>
          {!PRICES_PUBLIC && (
            <p className="mt-4 inline-block rounded-full border border-border bg-muted/60 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-muted-foreground">
              Pricing undisclosed · early access open
            </p>
          )}
        </div>
