...
export default function VerifyEmailPage() {
  ...
  const [expiry, setExpiry] = useState(15 * 60); // 15 minutes in seconds
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 text-center shadow-sm">
          ...
          {/* Expiry countdown */}
          {expiry > 0 ? (
            <div className="flex items-center justify-center gap-2 mb-6 px-4 py-3 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700">
            ...
            <div className="flex items-center justify-center gap-2 mb-6 px-4 py-3 rounded-xl bg-red-50 border border-red-200">
              <span className="text-xs font-sans text-red-600 font-semibold">
                ⚠️ Link has expired. Please request a new one.
              </span>
            </div>
          )}
        ...
        <p className="text-center text-xs text-muted-foreground mt-6 font-sans">
          ...
          <a href="mailto:support@nemo.app" className="text-primary hover:underline">
            contact support
          </a>
        </p>
      </div>
