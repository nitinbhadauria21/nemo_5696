...
export default function TrendCard({ trend, onBookmarkToggle }: TrendCardProps) {
  ...
  return (
    <article
      className="bg-card border border-border/80 rounded-2xl flex flex-col shadow-[0_1px_2px_rgba(15,10,5,0.04)] group hover:border-primary/35 hover:shadow-[0_10px_28px_rgba(15,10,5,0.08)] transition-all duration-200"
