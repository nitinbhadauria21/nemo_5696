    ...
    versions: [
      {
        ...
        deliveryNotes:
          'Speak fast and confident. Pause after the salary reveal. Use hand gestures when listing months.',
      },
      {
        id: 'v2',
        style: 'balanced',
        ...
        deliveryNotes:
          'Calm, authoritative tone. Make eye contact with camera. Slight pause between each point.',
      },
      {
        id: 'v3',
        style: 'storytelling',
        ...
        deliveryNotes:
          'Slow down on the "he laughed" moment. Build tension. Let the emotion show naturally.',
      },
    ],
  },
  {
    ...
    versions: [
      {
        ...
        deliveryNotes:
          'Fast-paced delivery. Show screen recordings of each tool. Use text overlays for the dollar amounts.',
      },
      {
        id: 'v2',
        style: 'balanced',
        ...
        deliveryNotes:
          'Professional but approachable. Show tool interfaces briefly. Keep energy high.',
      },
      {
        id: 'v3',
        style: 'storytelling',
        ...
        deliveryNotes:
          'Start with visible exhaustion in your voice. Let the energy build as you describe the transformation.',
      },
    ],
  },
  {
    ...
    versions: [
      {
        ...
        deliveryNotes:
          'Point at camera on the hook. Use a whiteboard or text overlay for the numbers.',
      },
      {
        id: 'v2',
        style: 'balanced',
      ...
      },
      {
        ...
        deliveryNotes:
          'Show before/after physique photos if possible. Genuine frustration in the first half, excitement in the second.',
      },
    ],
  },
  {
    ...
    versions: [
      {
        ...
        deliveryNotes:
          'Use a spreadsheet on screen. Show real numbers. Be vulnerable about past money mistakes.',
      },
      {
        id: 'v2',
        style: 'balanced',
        ...
        deliveryNotes:
          'Use chapter markers. Keep energy consistent throughout. Show real app screenshots.',
      },
      {
        id: 'v3',
        style: 'storytelling',
        ...
        deliveryNotes:
          "Be genuinely vulnerable. The emotional authenticity is what makes this version work. Don't over-produce it.",
      },
    ],
  },
  {
    ...
    versions: [
      {
        ...
        deliveryNotes:
          'Film in the morning with natural light. Show your actual routine briefly. Professional but personal.',
      },
      {
        id: 'v2',
        style: 'balanced',
        ...
        deliveryNotes:
          'Reference specific studies. Use data visualizations. Keep it credible and professional.',
      },
      {
        id: 'v3',
        style: 'storytelling',
        ...
        deliveryNotes:
          "Authentic and relatable. Don't make it sound too perfect. The struggle makes it believable.",
      },
    ],
  },
];
      ...
      >
        ...
        <div className="sticky top-0 bg-card border-b border-border px-5 py-4 flex items-start justify-between gap-3 z-10">
          <div className="min-w-0">
            <div className="flex items-center gap-2 mb-1 flex-wrap">
              <span
                className={`text-xs font-mono-custom px-2.5 py-1 rounded-full border ${getPlatformColor(script.platform)}`}
              >
                {script.platform}
              </span>
              {script.niche && (
          ...
          <div className="flex gap-2 overflow-x-auto pb-1">
            {script.versions.map((v) => (
              ...
              >
                ...
                <span className={`font-mono-custom font-bold ${getScoreColor(v.viralScore)}`}>
                  {v.viralScore}%
                </span>
              </button>
            ))}
        ...
        {version && (
          <div className="p-5 space-y-4">
            {/* Virality score */}
            <div
              className={`flex items-center gap-2 px-3 py-2 rounded-xl border w-fit ${getScoreBg(version.viralScore)}`}
            >
              <Icon
                name="FireIcon"
                size={14}
                variant="solid"
                className={getScoreColor(version.viralScore)}
              />
              <span
                className={`text-sm font-mono-custom font-bold ${getScoreColor(version.viralScore)}`}
              >
            ...
            <div className="p-4 bg-primary/5 border border-primary/15 rounded-xl">
              <p className="text-xs font-mono-custom uppercase tracking-wide text-primary font-bold mb-2">
                ⚡ Hook
              </p>
            ...
            {/* Body */}
            <div>
              <p className="text-xs font-mono-custom uppercase tracking-wide text-muted-foreground font-bold mb-2">
                Script Body
              </p>
            ...
            <div className="p-4 bg-accent/5 border border-accent/15 rounded-xl">
              <p className="text-xs font-mono-custom uppercase tracking-wide text-accent font-bold mb-2">
                Call to Action
              </p>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 cursor-pointer" onClick={onView}>
        <div className="flex items-center gap-2 mb-1 flex-wrap">
          <span
            className={`text-xs font-mono-custom px-2 py-0.5 rounded-full border ${getPlatformColor(script.platform)}`}
          >
            {script.platform}
          </span>
          {script.niche && (
      ...
      {/* Score */}
      <div
        className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-full border text-xs font-mono-custom font-bold tabular-nums flex-shrink-0 ${getScoreBg(bestScore)} ${getScoreColor(bestScore)}`}
      >
...
export default function SavedScriptsContent() {
  ...
  const handleBulkExport = () => {
    ...
    toExport.forEach((script, idx) => {
      ...
      lines.push(
        `Platform: ${script.platform} | Niche: ${script.niche || 'General'} | Generated: ${formatDate(script.generatedAt)}`
      );
      lines.push('');
  ...
  const handleDeleteSelected = async () => {
    ...
    if (isSupabaseConfigured()) {
      await Promise.all(
        ids.map((id) => fetch(`/api/scripts/${id}`, { method: 'DELETE' }).catch(() => null))
      );
    }
  ...
  const avgScore =
    scripts.length > 0
      ? Math.round(
          scripts.reduce((acc, s) => acc + Math.max(...s.versions.map((v) => v.viralScore)), 0) /
            scripts.length
        )
      : 0;
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground font-sans mt-0.5">
              Manage and export your viral script library
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            },
            {
              ...
              value: [...new Set(scripts.map((s) => s.platform))].length.toString(),
              icon: 'DevicePhoneMobileIcon',
              color: 'text-blue-500',
            },
            {
              label: 'Script Versions',
              value: scripts.reduce((a, s) => a + s.versions.length, 0).toString(),
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-2xl font-mono-custom font-extrabold text-foreground tabular-nums">
                  {stat.value}
                </p>
                <p className="text-sm text-muted-foreground font-sans font-medium leading-tight">
                  {stat.label}
                </p>
              </div>
            </div>
        ...
        {selectedIds.size > 0 && (
          <div className="flex items-center justify-between gap-3 px-4 py-3 bg-primary/10 border border-primary/20 rounded-2xl flex-wrap">
            <p className="text-sm font-sans font-medium text-foreground">
              <span className="font-bold text-primary">{selectedIds.size}</span> script
